...
export default function officeRoutes(app) {
  ...
  // POST /api/v1/offices/:id/register
  ...
  app.post(`${Constants.API_BASE_URL}/offices/interests`, AuthController.isAuthenticated, OfficeValidator.expressInterest, OfficeController.expressInterest);
  ...
  // GET /api/v1/offices/:id/interests
  app.get(`${Constants.API_BASE_URL}/offices/:id/interests`, AuthController.isAdmin, OfficeValidator.checkID, OfficeController.getInterests);
